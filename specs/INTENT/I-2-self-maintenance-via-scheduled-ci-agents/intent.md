...
- **Author:** Jason Lo
- **Last updated:** 2026-06-05 (refined — monthly refresh now opens one issue flagging only meaningful drift; regeneration/PRs flow through the same selection-triggered generate workflow)
